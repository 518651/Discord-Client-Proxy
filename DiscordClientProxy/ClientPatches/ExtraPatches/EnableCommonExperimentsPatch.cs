...
public class EnableCommonExperimentsPatch : ClientPatch
{
    ...
    public override async Task<string> ApplyPatch(string content)
    {
        ...
        content = content.Replace("label:\"WebAuthn\",kind:\"user\",defaultConfig:{enabled:!1}","label:\"WebAuthn\",kind:\"user\",defaultConfig:{enabled: true}");
        content = content.Replace("showTODOs:!1","showTODOs: true");
        
        /*
         label: "Premium upsell overlay",
        defaultConfig: { showPremiumUpsellOverlay: !1 },
        ...
        defaultConfig: { enableTestPage: !1 },
        
        label: "AA guild test for the new experiment config UI",
